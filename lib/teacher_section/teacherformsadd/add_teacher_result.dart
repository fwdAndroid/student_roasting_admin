...
class AddTeacherResult extends StatefulWidget {
  const AddTeacherResult({super.key});

  @override
  State<AddTeacherResult> createState() => _AddTeacherResultState();
}

class _AddTeacherResultState extends State<AddTeacherResult> {
  TextEditingController studentname = TextEditingController();
  TextEditingController studentgrade = TextEditingController();
  TextEditingController studentcomments = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  InputText(
                    ...
                    labelText: "He Need to work hard",
                    keyboardType: TextInputType.number,
                    onChanged: (value) {},
                    onSaved: (val) {},
                    textInputAction: TextInputAction.done,
